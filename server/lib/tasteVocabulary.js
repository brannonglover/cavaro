...
function canonicalLabelsFromKeywords(keywords = []) {
...
function extractTasteProfile(...parts) {
...
module.exports = {
  TASTE_PROFILE_FLAVORS: TASTE_PROFILE_SYNONYMS.map((entry) => entry.label),
  canonicalLabelsFromKeywords,
  extractTasteProfile,
};
